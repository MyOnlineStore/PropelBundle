...
use Propel\Bundle\PropelBundle\DataFixtures\Dumper\DataDumperInterface;
    ...
    protected function getDataAsArray($connectionName = null)
    {
        ...
        foreach ($tables as $tableName) {
            ...
            foreach ($resultsSets as $rows) {
                if ((\is_array($rows) || $rows instanceof \Countable ? \count($rows) : 0) > 0 && !isset($dumpData[$tableName])) {
                    $dumpData[$tableName] = [];
