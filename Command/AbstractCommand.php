...
abstract class AbstractCommand extends Command
{
    ...
    protected function callPhing($taskName, $properties = [])
    {
        ...
        try {
            ...
            // Guess errors
            if (
                \strstr($this->buffer, 'failed. Aborting.') ||
    ...
    protected function copySchemas(KernelInterface $kernel, $cacheDir)
    {
        ...
        foreach ($finalSchemas as $schema) {
            ...
            if (
                $this->input && $this->input->hasOption('connection') && $this->input->getOption('connection')
...
EOT;
    ...
    protected function getProperties($file)
    {
        ...
        foreach ($lines as $line) {
            ...
            $pos      = \strpos($line, '=');
            $property = \trim(\substr($line, 0, $pos));
    ...
    protected function checkConfiguration()
    {
        ...
        if (!isset($parameters['datasources']) || 0 === (\is_array($parameters['datasources']) || $parameters['datasources'] instanceof \Countable ? \count($parameters['datasources']) : 0)) {
    ...
    private function getPhingArguments(KernelInterface $kernel, $workingDirectory, $properties)
    {
        ...
        $properties = \array_merge([
            ...
            'propel.output.dir'         => $kernel->getProjectDir() . '/var/propel',
            'propel.php.dir'            => $kernel->getProjectDir(),
            'propel.packageObjectModel' => true,
            'propel.useDateTimeClass'   => true,
            'propel.dateTimeClass'      => \DateTime::class,
